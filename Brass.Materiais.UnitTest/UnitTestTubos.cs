using System;
using Brass.Materiais.Dominio.Fabricas;
...
namespace Brass.Materiais.UnitTest
{
    ...
    public class UnitTestTubos
    {
        ...
        public void MontagemCodigoBrass_Montar_Acertivo()
        {
            ...
            var montagemCodigo = new MontagemCodigoBrass();
            montagemCodigo.MontarCodigo(SIGLA_PECA, SIGLA_MATERIAL, SIGLA_FAB, SIGLA_EXT, SIGLA_REVEST, SIGLA_ESPESSURA, SIGLA_DIAMETRO);
        }
