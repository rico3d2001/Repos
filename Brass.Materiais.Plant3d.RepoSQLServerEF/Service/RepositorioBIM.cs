using Brass.Materiais.Plant3dDiagramas.RepoSQLServerEF;
...
namespace Brass.Materiais.Plant3d.RepoSQLServerEF.Service
{
    public class RepositorioBIM<T> : IRepositorioBIM<T> where T : class, new()
    {
            ...
            public RepositorioBIM(string tipo,string database)
            {
                ...
                switch (tipo)
                {
                    case "Local":
                        ...
                        break;
                case "Plant3d_Model3D":
                    _contexto = new Plant3d_PipingEntities();
                    break;
