...
namespace Brass.Materiais.DominioPQ.BIM.ViewsPlant
{
    public class Valve_PNP
    {
        ...
        //public string? ValveBodyType { get; set; }

        //public int? FlowDependent { get; set; }
        //public int? Offset { get; set; }

        //public string? OperatorType { get; set; }
        //public string? ActuatorType { get; set; }

        //public double? ActuatorHeight { get; set; }
        //public double? ActuatorWidth { get; set; }

        //public int? ControlValve { get; set; }

        //public string? ValveCode { get; set; }
        //public string? Normally { get; set; }
        //public string? Failure { get; set; }
        //public string? EndConnections { get; set; }
