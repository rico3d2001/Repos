...
namespace Brass.Materiais.ApiEstados.Controllers
{
    [EnableCors("MyPolicy")]
    ...
    public class EstadoAppController : ControllerBase
    {
        ...
        public Task<EstadoApp> ObterEstadoAppQuery(string siglaUsuario, string guidDisciplina)
        {
            var query = new ObterEstadoAppQuery(siglaUsuario, guidDisciplina);
