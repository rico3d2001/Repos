...
namespace Brass.Materiais.Dominio.Servico.Commnads
{
    public class InjetaItemCompleto
    {
        ...
        private List<TabelaP3D> CapturarListaTabelasPlant3d()
        {
            ...
            var repo = new RepositorioService<PnPTables>();
            var dominioService = new DominioService<PnPTables>(repo);
        ...
        private List<EngineeringItems> capturarItensEngenhariaPlant3d()
        {
            ...
            var repo = new RepositorioService<EngineeringItems>();
            var dominioService = new DominioService<EngineeringItems>(repo);
