namespace Brass.Materiais.Dominio.Servico.Commnads
{
    ...
    //        List<RamalArvoreCatalogo> ramals = ExtraiArvoreAramzen();

    //        _ramalEstoqueService.Carregar(ramals);

    //    }

    //    public List<RamalArvoreCatalogo> ListaRamaisArvore()
    //    {
    //        List<RamalEstoque> ramaisEstoque = new List<RamalArvoreCatalogo>();
